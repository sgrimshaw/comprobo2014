...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'neato_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sharong/Documents/comp-robo/comprobo2014/install/${idir}'.  Ask the maintainer 'Michael Ferguson <ferguson@cs.albany.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sharong/Documents/comp-robo/comprobo2014/install/lib;/opt/ros/hydro/lib)
